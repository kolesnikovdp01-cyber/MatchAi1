...
• 0.63–0.71: данных мало, но анализ возможен — используй экспертные знания, рискLevel="high"
• < 0.63 → {"skip": true, "reason": "Страх сильнее жадности — пропускаю"}
...
${hasRealStats
  ? stats.statsText
  : `Статистика API недоступна — используй экспертные знания о командах.
Установи confidence 0.65–0.71, riskLevel="high". НЕ пропускай — дай прогноз на основе:
• ${homeTeam}: форма, стиль, голы, оборона
• ${awayTeam}: форма, стиль, голы, оборона
• H2H из памяти (последние 5 матчей)
